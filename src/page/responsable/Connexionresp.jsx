...
const LoginPageresp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_BACK_URL}/api/login-responsable/`, {
        ...
        <Slide direction="down" in={true} timeout={500}>
          <Box sx={{ mb: 4, textAlign: 'center' }}>
            ...
            <Typography variant="h4" component="h1" sx={{ fontWeight: 'bold', mb: 1 }}>
              Connexion <HighlightText>responsable</HighlightText>
            </Typography>
